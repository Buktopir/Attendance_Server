...
from src.users.authentication import AuthenticationBackend, Authenticator
from src.users.jwt import SecretType
from src.users.manager import UserManagerDependency
from src.users.router import (
    get_auth_router,
    get_register_router,
...
try:
    ...
    from src.users.router import get_oauth_router
